...
## Current images:
- Debian Trixie (v13) with Linux kernel 6.12.48
- Ubuntu Plucky Puffin (v25.04) with Linux kernel 6.12.48
- Preview Ubuntu Questing Quokka (v25.10) with Linux kernel 6.12.48
